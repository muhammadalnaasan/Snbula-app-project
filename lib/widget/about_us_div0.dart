...
class AboutUsDiv0 extends StatefulWidget {
  const AboutUsDiv0({super.key});

  @override
  State<AboutUsDiv0> createState() => _AboutUsDiv0State();
}

class _AboutUsDiv0State extends State<AboutUsDiv0> {
  int currntIndex = 0;
